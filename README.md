...
```bash
$ whoami
> mohab@hobzsec:~$ Cybersecurity Engineer specialized in Penetration Testing, systems programming, and offensive security research
$ ./expertise.sh --advanced-skills
> [Loading complete]: Internal Pentesting | Web Pentesting | Reverse Engineering 
$ uname -a
...
<br>
    فَالْمَرْءُ فِي الدُّنْيَا حَدِيثٌ يُذْكَرُ
...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=C6BBB7&height=150&section=footer&text=ٍSecurity%20Engineer,%20Penetration%20Testing,%20Build%20the%20Future&fontSize=20&fontColor=FFFFFF&animation=fadeIn&fontAlignY=65" width="100%"/>
</div>
